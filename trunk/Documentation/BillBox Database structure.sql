...
/*
ALTER TABLE AgentBranch
ADD CONSTRAINT FK_AgentBranch_Parish FOREIGN KEY (ParishId) REFERENCES Parish (ParishId) ON DELETE CASCADE ON UPDATE CASCADE;
*/
GO
...
/*
ALTER TABLE AgentUser
ADD CONSTRAINT FK_AgentUser_Parish FOREIGN KEY (ParishId) REFERENCES Parish (ParishId) ON DELETE CASCADE ON UPDATE CASCADE;
*/
...
ALTER TABLE Payment
ADD CONSTRAINT FK_Payment_AgentUser FOREIGN KEY (AgentUserId) REFERENCES AgentUser (UserId) ON DELETE CASCADE ON UPDATE CASCADE;
*/
...
/*
ALTER TABLE PaymentCaptureField
ADD CONSTRAINT FK_PaymentCaptureField_CaptureField FOREIGN KEY (CaptureFieldId) REFERENCES CaptureField (CaptureFieldId) ON DELETE CASCADE ON UPDATE CASCADE;
*/
